...
RegisterNetEvent('qb-pizzathis:create:burgerbleeder', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-pizzathis:create:burgermoneyshot', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-pizzathis:create:burgerheartstopper', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-pizzathis:create:torpedo', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('qb-pizzathis:create:burgermeatfree', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('qb-pizzathis:server:get:ingredientBurger', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('qb-pizzathis:server:get:ingredientTorpedo', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local meat = Ply.Functions.GetItemByName("burger-meat")
    local bun = Ply.Functions.GetItemByName("burger-bun")
...
QBCore.Functions.CreateCallback('qb-pizzathis:server:get:ingredientMeatfree', function(source, cb)
    local src = source
    local Ply = QBCore.Functions.GetPlayer(src)
    local bun = Ply.Functions.GetItemByName("burger-bun")
    local tomato = Ply.Functions.GetItemByName("burger-tomato")
...
RegisterNetEvent('qb-pizzathis:add:fries', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
